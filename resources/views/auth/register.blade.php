        ...
        <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <div class="flex space-x-2">
                    <div class="w-1/2">
                        ...
                        <input type="text" name="first_name" placeholder="John" id="first_name" required
                            class="w-full mt-1 bg-white border border-gray-300 px-3 py-2 rounded-md focus:ring focus:ring-blue-200">
                    </div>
                    <div class="w-1/2">
                ...
                <input type="email" name="email" placeholder="your.email@example.com" required
                    class="w-full bg-white border border-gray-300 px-3 py-2 rounded-md focus:ring focus:ring-blue-200">

                {{-- Username --}}
                <label for="username" class="block text-sm font-medium text-gray-700 mb-1">Username</label>
                <input type="text" name="username" placeholder="Username" required
                    class="w-full border bg-white border-gray-300 px-3 py-2 rounded-md focus:ring focus:ring-blue-200">
                ...
                <div class="flex items-start space-x-2">
                    ...
                    <label for="terms" class="text-sm text-gray-700">
                        I agree to the <a href="#" class="text-blue-600 bg-white hover:underline">Terms of Service</a>
